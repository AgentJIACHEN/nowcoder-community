...
public class UserController implements CommunityConstant {
    ...
    public String getProfilePage(@PathVariable("userId") int userId, Model model) {//@PathVariable：接收请求路径中占位符的值
    ...
    public String getMyPost(@PathVariable("userId") int userId, Page page, Model model) {
        ...
        List<DiscussPost> discussList = discussPostService
                .findDiscussPosts(userId, page.getOffset(), page.getLimit(),0);//按最新来排序帖子。
